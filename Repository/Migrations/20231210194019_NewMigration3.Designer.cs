...
namespace Repository.Migrations
{
    ...
    [Migration("20231210194019_NewMigration3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Discount", b =>
                {
                    b.HasOne("Core.Domain.Doctor", "doctorCoupon")
                        .WithMany("discounts")
                        .HasForeignKey("doctorCouponID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("doctorCoupon");
                });
